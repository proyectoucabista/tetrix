...
var Recorrer,x,y,Tope_Matriz,fila,b,c,velocidad,linea,contador,SumaP,NumFig,j:integer;
  ...
  Puntos,i,auxscore:integer;           // Declara una variable para guardar el resultado del juego (puntos del juego)
...
begin
  ...
  NumFig:=FiguraActual;
                        ...
                        gotoxy(55,12); writeln('Nombre: ',Upcase(auxNombre));
                        gotoxy(55,13); writeln('Origen: (',Upcase(auxEstado),')');

                        gotoxy(55,2); writeln('RECORD: ',auxScore);
...
begin
           ...
           //INICIALIZAR
            ...
            repeat
             ...
             until (tec='1') or (tec='2'); // repetir hasta escoger opcion valida(numeros)
